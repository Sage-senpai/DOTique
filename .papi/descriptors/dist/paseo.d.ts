...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I9r50es55ojtn8>, false, never>;
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I3ai28hc4q2de3>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<Ie0idkji15j6h>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<Ia3i0r1stq01s>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I3vatbe8m9q5l1>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I30fr8jovg3oip>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ie2crhers0eaj8>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<Ias67hvfei9kqs>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ie2crhers0eaj8>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I8beo5uq2e4rvf>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ie2crhers0eaj8>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Iej3q5gf7b5hi5>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<Ic415ebitbgp80>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I8beo5uq2e4rvf>>;
    };
    Proxy: {
        /**
         ...
         */
        proxy: TxDescriptor<Anonymize<Id0pnetdc5ihgv>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Ifgv5hotni0ohe>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ic7tv7415nfec9>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I2mcu80t7lmhn8>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I30fr8jovg3oip>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Iej3q5gf7b5hi5>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I73ueliirpv9rr>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I67htsdqkc1it1>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Iff6k6qjubahao>>;
    };
    Scheduler: {
        /**
         * Scheduled some task.
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Ict3frru6b33qe>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<Ipqh316ne4074>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Ie99ut6t4omcbp>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I6fkfm1q2cij0u>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I16bk1rdc5jk5g>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I63ikt1keojf39>>;
    };
    Proxy: {
        /**
         * A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I16bk1rdc5jk5g>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I21mbe83d5f8l8>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<I5ksvia2l0ln9n>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<Iftlffr081n741>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I7jujv8bp1e9fr>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I7jujv8bp1e9fr>>;
    };
    RcMigrator: {
        /**
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<I2ns1pl067o9bo>, proxy_type: Anonymize<I7adrgaqb51jb9>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Ie1nsd9t70rb99>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I2ns1pl067o9bo>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I2ns1pl067o9bo>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<Icqnsdsc2kqh8a>, call: Anonymize<I2ns1pl067o9bo>, result_xcms_version: number], Anonymize<I5gvn7pn2nbnfh>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I2df9cmsph9pvl>>;
    };
    /**
...
export type PaseoDispatchError = Anonymize<Ieaka0hmjlsgs3>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PaseoCallData = Anonymize<I2ns1pl067o9bo> & {
    value: {
        type: string;
    };
};
