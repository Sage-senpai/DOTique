...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<It7qcaj7km1bm>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I6tr4vvvpodmo5>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<I67acu81asdcph>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I6tr4vvvpodmo5>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I2beoj5vj530h>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I6tr4vvvpodmo5>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Ie8sdlkpldtn3e>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<I887oto03rd7qo>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I2beoj5vj530h>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ibvneoids3m0ss>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ia08jhnkgp5svs>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I922l9lsr4rnb6>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I7rpi7dplcq5i>>;
        /**
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<Ifgi97m8q0ij1r>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Ie8sdlkpldtn3e>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I5s6r30ehp9h9>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I89m7jda6fu686>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Ifaip9nh7v9m6l>>;
    };
    ParachainSystem: {
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Ibs9nuvro2udt6>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I35bhc5vu7f1oq>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I1kkjgdquqmefi>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I3opqs135m9m85>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I6dicbupjngoqa>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I1kkjgdquqmefi>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I13k8935e02ja4>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I13k8935e02ja4>>;
    };
};
type IError = {
    System: {
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<I1ugs7nm404ajb>, proxy_type: Anonymize<Ieuemnllefri8h>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Ikcej9tc51tms>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I1ugs7nm404ajb>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I1ugs7nm404ajb>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I9g869l9vmunib>, call: Anonymize<I1ugs7nm404ajb>, result_xcms_version: number], Anonymize<I8bi6p4u3jmjte>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Idgar1svvek0i>>;
    };
    /**
...
export type Paseo_peopleDispatchError = Anonymize<I7qsu55s2h499m>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
declare const _allDescriptors: Paseo_people;
export default _allDescriptors;
export type Paseo_peopleApis = ApisFromDef<IRuntimeCalls>;
export type Paseo_peopleQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Paseo_peopleCalls = TxFromPalletsDef<PalletsTypedef>;
export type Paseo_peopleEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Paseo_peopleErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Paseo_peopleConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Paseo_peopleViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Paseo_peopleCallData = Anonymize<I1ugs7nm404ajb> & {
    value: {
        type: string;
    };
};
export type Paseo_peopleWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
