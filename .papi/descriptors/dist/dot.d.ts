...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I1uqcr7emda4s6>, false, never>;
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<Iebhao6oshfbpi>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I21n6ecgu30msv>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I8eqtsq0533q8e>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<Ic5p5igrn95ba>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I6ptk31dtl7q1p>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ii9551ejog03s>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I1a0ts6hc1hvud>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ii9551ejog03s>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Ib4le4lsuecifn>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ii9551ejog03s>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I7c7h03ms5tnvh>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<I97q1dtdh2vtol>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<Ib4le4lsuecifn>>;
    };
    Proxy: {
        /**
         ...
         */
        proxy: TxDescriptor<Anonymize<Ickugfp2o26pvk>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I4rk374t9r8hbh>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Id6cgvp0pc7u6f>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ib8t7t98985jms>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I3qejj0cok2j8>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Iechj4ts0g5ckg>>;
    };
    Scheduler: {
        /**
         * Scheduled some task.
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Idfht5gdgfe5lr>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<I7c2916grn457m>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I7jkrn0pd4cs4c>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I8okburaslbfdq>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I4pacffg83t3nk>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I8abu9516qf1t7>>;
    };
    Proxy: {
        /**
         * A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I4pacffg83t3nk>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Ib9uipi5f61mui>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<Ibg4ut99o2n42j>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<Id6vn8ufje55ho>>;
        /**
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<Ironaioq8hfkf>, proxy_type: Anonymize<I7adrgaqb51jb9>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Ic128seq3h50ce>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ironaioq8hfkf>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ironaioq8hfkf>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I39p61kmiacrk5>, call: Anonymize<Ironaioq8hfkf>, result_xcms_version: number], Anonymize<I56q5t929cfbhk>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I6e7gvobmmiamj>>;
    };
    /**
...
export type DotDispatchError = Anonymize<I4hafmetfoc84g>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
